package p1.designPattern.decorateur;
 ...
 * keeping class methods signature intact. We are demonstrating the use of decorator pattern via following example
 * in which we will decorate a shape with some color without alter shape class.
 */
public class DecorateurMain {
